...
export function Login(props) {
  ...
  const [focusedProfileId, setFocusedProfileId] = React.useState<string | null>(null);
  ...
  if ($[6] !== props.startingMessage || $[7] !== t1 || $[8] !== setTextInputActive) {
    t2 = <ConsoleOAuthFlow onDone={t1} startingMessage={props.startingMessage} onTextInputActive={setTextInputActive} onFocusedProfileId={setFocusedProfileId} onConfirmingDelete={setConfirmingDelete} />;
  ...
  const t3_isCancelActive = !textInputActive && !confirmingDelete;
